...
- 为了体验CICD,实现了git提交后触发钩子,由jenkins,自动部署到线上(因为只有一台服务器,又要跑很多服务,所以用的docker) [使用记录](https://juejin.cn/post/6916016350490001415)
- 为了体验微前端,拆分客服工单 -> 创建工单页面使用qiankun框架,拆分系统设置 -> 权限控制 -> 客服权限使用single-spa [使用记录](https://juejin.cn/post/6917245057896710158)
- 为了体验websocket,所以工单详情聊天使用了websocket来处理实时接受信息和提示 [使用记录](https://juejin.cn/post/6926744616419426311)
